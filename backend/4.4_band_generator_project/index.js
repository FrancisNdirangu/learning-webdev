...
app.post("/submit", (req, res) => {
  ...
  const randNumAdj = Math.floor(Math.random()*adj.length);
  console.log(randNumAdj);

  const randAdj = adj[randNumAdj];
  console.log(randAdj);

  const randNumNoun = Math.floor(Math.random()*noun.length);
  console.log(randNumNoun);
